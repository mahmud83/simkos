    ...
    protected function initDefaultButtons()
    {
        if (!isset($this->buttons['view'])) {
            $this->buttons['view'] = function ($url, $model, $key) {
                ...
                return Html::a('<button class="btn btn-info"><i class="glyphicon glyphicon-eye-open"></i> Lihat</button>', $url, $options);
            };
        }
        if (!isset($this->buttons['update'])) {
            $this->buttons['update'] = function ($url, $model, $key) {
                ...
                return Html::a('<button class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i> Edit</button>', $url, $options);
            };
        }
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model, $key) {
                $options = array_merge([
                    ...
                    'data-confirm' => Yii::t('yii', 'Apakah anda yakin akan menghapus data ini?'),
                    'data-method' => 'post',
                    'data-pjax' => '0',
                ], $this->buttonOptions);
                return Html::a('<button class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i> Hapus</button>', $url, $options);
            };
        }
    }
